...
export type ProjectModelFilter = {
  ...
  livePreview?: InputMaybe<StringFilter>;
...
export enum ProjectModelOrderBy {
  ...
  githubRepo_ASC = 'githubRepo_ASC',
  githubRepo_DESC = 'githubRepo_DESC',
  id_ASC = 'id_ASC',
  id_DESC = 'id_DESC',
  livePreview_ASC = 'livePreview_ASC',
  livePreview_DESC = 'livePreview_DESC',
  main_ASC = 'main_ASC',
  main_DESC = 'main_DESC',
  name_ASC = 'name_ASC',
  name_DESC = 'name_DESC',
...
export type ProjectRecord = RecordInterface & {
  ...
  id: Scalars['ItemId'];
  livePreview?: Maybe<Scalars['String']>;
  main?: Maybe<Scalars['BooleanType']>;
  name?: Maybe<Scalars['String']>;
  photos: Array<FileField>;
  techStack?: Maybe<Scalars['JsonField']>;
